...
std::string inputDomainToString(MeshFilterInputDomain domain)
{
    switch (domain) {
...
FilterRunRecord MeshSetCore::applyFilter(const std::string &filterNameOrKey, const nb::dict &params) const
{
    try {
